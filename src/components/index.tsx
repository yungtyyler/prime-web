...
export { default as HomeSection } from './sections/Home';
...
export { default as HomeBanner } from './misc/HomeBanner';
...
export { NavLinks, FooterLinks, CarouselSlides } from './links/Links';
