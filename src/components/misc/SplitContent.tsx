      ...
      {left ? (
        ...
        >
          <div
            ...
            } md:max-w-[75%] w-full h-full bg-gradient-to-r from-prime-saffron to-prime-saffron-700 shadow-lg md:rounded-xl rounded-r-xl absolute -left-4 top-0 transition-all ease-out duration-[1250ms] flex flex-col md:items-start items-center justify-center p-8 md:text-start text-center lg:gap-12 gap-2 text-prime-eerie-black`}
          >
