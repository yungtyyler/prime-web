      ...
      <div className="section__container relative z-20 w-full">
        <div className="flex md:flex-row flex-col gap-6 items-center justify-center w-full h-full">
          <div
            ...
            } transition-all ease-linear duration-500 delay-1000 bg-gradient-to-br from-white via-prime-saffron to-prime-saffron-700 w-[1000px] h-[1000px] rounded-full absolute -z-0 left-[40%]`}
          />
          <div
            ref={ref}
            className={`${
              isInView ? 'opacity-60' : 'opacity-0 -translate-y-24'
            } transition-all ease-linear duration-500 delay-1000 bg-gradient-to-tl from-prime-eerie-black to-prime-jet w-[1000px] h-[1000px] rounded-full absolute -z-10 right-[40%] top-10`}
          />
          <div className="w-full z-20 flex flex-col justify-center p-4 bg-white bg-opacity-75 h-fit mx-4 rounded-lg drop-shadow-2xl md:max-w-[50%]">
            <h3 className="text-[2em] font-bold my-4">Get In Touch Today!</h3>
            <p className="tracking-wider text-[1.1em]">
