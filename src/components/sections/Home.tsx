...
const Home = () => {
  return (
    <div className="relative md:py-[400px] w-full h-full justify-center md:items-start items-center md:px-10">
      ...
      />
      <div className="section__container justify-center top-[60px] absolute md:static">
        <div className="z-10 bg-opacity-600 rounded-xl shadow-2xl bg-prime-jet px-8 py-12 flex flex-col md:items-start items-center text-white text-center md:text-start gap-4 max-w-2xl w-full">
